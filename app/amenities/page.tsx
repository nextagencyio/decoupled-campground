...
import { GET_AMENITY_TEASERS } from '@/lib/queries'
import { AmenityTeaserData } from '@/lib/types'
...
export const metadata: Metadata = {
  title: 'Amenities | Pinecrest Campground',
  description: 'Explore our campground amenities including the camp store, laundry, showers, and more.',
}
...
async function getAmenities() {
  try {
    ...
    const { data } = await apolloClient.query<AmenityTeaserData>({
      query: GET_AMENITY_TEASERS,
      variables: { first: 50 },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center pt-8">
            ...
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Everything you need for a comfortable stay in the great outdoors.
            </p>
          </div>
        </div>
      </section>
